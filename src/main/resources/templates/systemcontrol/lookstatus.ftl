                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" readonly="readonly" value="${(status.statusModel)!''}"/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>状态</span></label>
                                <input class="form-control" readonly="readonly" value="${(status.statusName)!''}"/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>排序值</span></label>
                                <input class="form-control" readonly="readonly" value="${(status.sortValue)!''}"/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>颜色</span></label>
                                <input class="form-control" readonly="readonly" value="${(status.statusColor)!''}"/>
                            </div>
