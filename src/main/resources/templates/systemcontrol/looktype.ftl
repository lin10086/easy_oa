                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" readonly="readonly" value="${(typeObj.typeModel)!''}"/>
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="control-label"><span>类型</span></label>
                            <input class="form-control" readonly="readonly" value="${(typeObj.typeName)!''}"/>
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="control-label"><span>排序值</span></label>
                            <input type="number" min="0" class="form-control" readonly="readonly"
                                   value="${(typeObj.sortValue)!''}"/>
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="control-label"><span>颜色</span></label>
                            <input class="form-control" readonly="readonly" value="${(typeObj.typeColor)!''}"/>
                        </div>
                    </div>
                </div>
            </div>
