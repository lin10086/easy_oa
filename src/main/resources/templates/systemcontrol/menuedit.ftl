...
<div class="row" style="padding-top: 15px;">
    <div class="col-md-12">
        ...
        <div class="bgc-w box">
            ...
            <form action="tablereceive" method="post" id="thisForm" onsubmit="return check();">
                <!--盒子身体-->
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <#--  <div class="col-md-6 form-group">
                                  ...
                                  &lt;#&ndash;<#if getAdd??>
                                      <input type="number" min="0" class="form-control" value="${getAdd}" name="parentId"
                                             readonly="readonly"/>
                                  <#else>
                                      <input type="number" min="0" class="form-control" value="${(menuObj.parentId)!''}"
                                             name="parentId"/>
                                  </#if>&ndash;&gt;
                              </div>-->
                            <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <#else>
                                    <span class="labels"><label><input name="isShow"
