                ...
                <div class="box-header">
                    <table class="bo table ">
                        ...
                        <tr>
                            ...
                            <td colspan="13" style="text-align: right;"><i class="glyphicon glyphicon-plus trazeng"></i>&nbsp;&nbsp;&nbsp;<i
                                        class="glyphicon glyphicon-minus trajian"></i></td>
                            ...
                            <td colspan="14">
                                <div class="food">
                                    <table class="table inside">
                                        ...
                                        <tr>
                                            <td class="chebox"><span class="labels"><label><input type="checkbox"
                                                                                                  name="top"
                        ...
                        <tr>
                            ...
                            <td colspan="13" style="text-align: right;"><i
                                        class="glyphicon glyphicon-plus stayzeng"></i>&nbsp;&nbsp;&nbsp;<i
                                        class="glyphicon glyphicon-minus stayjian"></i></td>
