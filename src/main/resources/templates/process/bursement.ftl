                    ...
                    <table class="bo table ">
                        ...
                        <tr>
                            ...
                            <td colspan="6">
                                <select class="form-control inpu" name="typeId">
                                    <#list reimbursementTypeVOList as reimbursement>
                                        <option value="${reimbursement.typeId}">${reimbursement.typeName}</option>
                                    </#list>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="6"><textarea class="form-control text"
                                                      name="processListVO.processDescribe"></textarea></td>
                        </tr>
                        <tr>
                                ...
                                <div class="food">
                                    <table class="table inside">
                                        ...
                                        <tr class="tr">
                                            ...
                                            <td colspan="2"><input type="text" class="form-control inpu"
                                                                   name="detailsReimburseVOList[0].invoices"/></td>
                                            <td colspan="2" class="tdrig"><input type="text" class="form-control inpu"
                                                                                 name="detailsReimburseVOList[0].detailMoney"/>
                                            </td>
...
//	return false;
    ...
    $(function () {
        ...
        $(".zeng").click(function () {
            ...
            var td2 = $('<td  colspan="2"></td>').append($('<input type="text" class="form-control inpu incar" name="detailsReimburseVOList[' + i + '].produceTime"/>').val(star));
            var td3 = $('<td colspan="2"></td>').append($('<input type="text" class="form-control inpu" name="detailsReimburseVOList[' + i + '].subject" readonly="readonly" style="background-color:#fff;"/>'))
                .append($('<div class="sub"></div>').append($('<i class="glyphicon glyphicon-search"></i>')));
            var td4 = $('<td colspan="2"></td>').append($('<input type="text" class="form-control inpu" name="detailsReimburseVOList[' + i + '].descript"/>'));
            var td5 = $('<td colspan="2"></td>').append($('<input type="text" class="form-control inpu" name="detailsReimburseVOList[' + i + '].invoices"/>'));
            var td6 = $('<td colspan="2" class="tdrig"></td>').append($('<input type="text" class="form-control inpu" name="detailsReimburseVOList[' + i + '].detailMoney"/>'));
