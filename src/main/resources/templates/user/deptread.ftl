								...
								<table class="table table-hover table-striped">
									...
									<#list deptUser as user>
										<tr>
											...
											<td><span>${user.positionVO.positionName}</span></td>
							...
							<div class="row">
								<#if deptVOManage??>
									<div class="col-md-12">
										...
										<input type="hidden" name="deptId" value="${(dept.deptId)!''}">
										<input type="hidden" name="oldManageId" value="${deptVOManage.userId}" />
									</div>
									<div class="col-md-6">
										<label class="control-label"> <span>部门</span></label>
										<select class="deptselect form-control" name="changeDeptId">
									...
									<div class="col-md-6">
										<label class="control-label"> <span>职位</span></label>
										<select class="positionselect form-control" name="changePositionId">
											<#list positions as position>
												<option value="${position.positionId}">${position.positionName}</option>
												<#--<option value="${position.id}">${position.name}</option>-->
											</#list>
