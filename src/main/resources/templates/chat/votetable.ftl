                ...
                <tr>
                    ...
                    <td style="width: 200px;">
                        <a style="width:72px;marign-right:10px;display:inline-block;" class="votethis"
                           href="javascript:void(0);" disabled="disabled" discussId="${discuss.discussId}"
                           titleId="${voteTitle.titleId}">
                        ...
                        <a href="#vote${voteTitle.titleId}" data-toggle="collapse" =><span
                                class="label label-primary"><i class="glyphicon glyphicon-list"></i> 投票详情</span></a>
                    </td>
                </tr>
                <#if voteTitle.voteTitleUserPOS?size gt 0>
                    <tr id="vote${voteTitle.titleId}" class="collapse">
                        <td colspan="3">
                            ...
                            <span class="likethisnum">
									<#list voteTitle.userVOList as userVO>
                                        <a
                                                class="usershow"
                                                title="${userVO.userName}"
                                                thisdept="${userVO.deptVO.deptName}"
                                                thisrole="${userVO.roleVO.roleName}"
                                                thistel="${(userVO.userTel)!'空的'}"
                                                thisemail="${(userVO.userEmail)!'空的'}"
                                                href="javascript:void(0);" style="color: #888;font-size: 12px;"><img
                                                    src="/image/${(userVO.imgPath)!'timg.jpg'}"
                                                    title="${userVO.userName}" alt="${userVO.userName}"
                                                    class="small-img"/></a>
                                    </#list>
