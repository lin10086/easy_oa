        ...
        <div class="box-body">
            ...
            <div class="form-group addvote" style="display:none;">
                ...
                <select name="selectOne" class="form-control" style="margin-bottom: 15px;" disabled="disabled">
                    ...
                    <#if voteList??>
                        <input name="inReceiver" type="text" id="inputtext" style="background-color: #fff;"
                               class="form-control" placeholder="投票标题" disabled="disabled"/>
                    <#else>
                        <input name="inReceiver" type="text" id="inputtext" style="background-color: #fff;"
                               class="form-control" placeholder="投票标题"/>
                    </#if>
                    <div class="reciver pull-right add"
                         style="display: inline-block;margin-top: 2px;margin-right: 33px;">
                    ...
                    <#if voteList??>
                        <table class="table" cellspacing="0" border="0"
                            ...
                            <#list voteTitles as title>
                                <tr>
                                    <td>
                                        <input type="text" name="votetitle" value="${title.title}"
                                               class="form-control textvalue" disabled="disabled">
                                    </td>
                                    <td style="width:150px;">
                                        <input type="text" name="votecolor" value="${title.color}" class="form-control"
                                               disabled="disabled">
                                    </td>
                                    <td style="width:150px;">
