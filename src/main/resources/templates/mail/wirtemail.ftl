...
<div class="bgc-w box box-primary" style="min-height: 613px;">
    ...
    <form action="pushmail" method="post" enctype="multipart/form-data" onsubmit="return check();">
        <div class="box-body">
            ...
            <div class="form-group">
                <#if id=="回复"||id=="转发">
                    <textarea name="content" class="form-control tent"
                              style="width: 100%; height: 300px; visibility: hidden; font-size: 20px;"><br/><hr/>${(content)!''}</textarea>
                <#else>
                    <textarea name="content" class="form-control tent"
                              style="width: 100%; height: 300px; visibility: hidden; font-size: 20px;">${(content)!''}</textarea>
                </#if>
            </div>
