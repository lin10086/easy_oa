...
public class RolePowerListPOSqlProvider {

    public String countByExample(RolePowerListPOExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("aoa_role_power_list");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(RolePowerListPOExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("aoa_role_power_list");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(RolePowerListPO record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("aoa_role_power_list");
    ...
    public String selectByExample(RolePowerListPOExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        RolePowerListPO record = (RolePowerListPO) parameter.get("record");
        RolePowerListPOExample example = (RolePowerListPOExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("aoa_role_power_list");
    ...
    public String updateByPrimaryKeySelective(RolePowerListPO record) {
        SQL sql = new SQL();
        sql.UPDATE("aoa_role_power_list");
    ...
    protected void applyWhere(SQL sql, RolePowerListPOExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
