...
import cn.gson.oasys.ServiceV2.discussV2.DiscussListPOServiceV2;
import cn.gson.oasys.ServiceV2.discussV2.DiscussServiceV2;
import cn.gson.oasys.ServiceV2.discussV2.VoteServiceV2;
...
//============================================================
    ...
    public String adminManage(@RequestParam(value = "page", defaultValue = "1") int page,
                              ...
                              @SessionAttribute("userId") Long userId,
                              Model model) {
        List<DiscussListPO> discussListPOS = discussServiceV2.paging(page, null, 1L, null, null, null);
    ...
    public String chatManage(@RequestParam(value = "page", defaultValue = "1") int page,
                             @SessionAttribute("userId") Long userId, Model model, HttpSession session) {
        List<DiscussListPO> discussListPOS = discussServiceV2.paging(page, null, userId, null, null, null);
    ...
    public String chatList(@RequestParam(value = "page", defaultValue = "1") int page, Model model, HttpSession session) {
        List<DiscussListPO> discussListPOS = discussServiceV2.paging(page, null, null, null, null, null);
