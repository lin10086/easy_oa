...
public class PageInformation {
     ...
     * @return
     */
    public List<AttendanceVO> getAttendancesVOListPage(int page, int size, List<AttendsPO> attendsPOList, HttpServletRequest request) {
        ...
        List<AttendanceVO> attendanceVOList = attendanceServiceV2.getAttendancesVOListByAttendancesPOList(subAttendsPOList);
